<template>
    ...
    <div class="lg:container mx-auto px-4 py-2 bg-red-400">
        ...
        <div class="grid grid-cols-2 grid-rows-2 gap-4 mb-12">
            <div class="bg-blue-400">프로젝트2 기간</div>
            <div class="bg-blue-400 row-span-2">프로젝트2 대표이미지</div>
        ...
        <div class="flex justify-between mb-12">
            <div class="bg-indigo-400" style="height: 60px; width:100px;"><a href="/detail">이전페이지</a></div>
            <div class="bg-indigo-400" style="height: 60px; width:100px;"><a href="/detail3">다음페이지</a></div>
        </div>
    </div>
